...
var _ = Describe("Version", func() {
	DescribeTable("ChartVersionFromDescribe",
		...
		Entry("three-component tag on commit", "helm-", "helm-1.2.3", "abc1234", "1.2.3"),
		Entry("three-component tag not on commit", "helm-", "helm-1.2.3-5-gabc1234", "abc1234", "1.2.3.5+gabc1234"),
		Entry("empty describe output", "helm-", "", "abc1234", ""),
		Entry("empty tag prefix", "", "helm-1.2", "abc1234", "helm.1.2"),
	)
